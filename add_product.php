  ...
  <div class="col-md-9">
    <div class="panel panel-default shadow-sm">
      <div class="panel-heading">
        <strong>
          <i class="fas fa-box-open text-info h5 m-0 mr-1"></i>
        ...
        <div class="col-md-12">
          <form method="post" action="add_product.php" class="clearfix">
            <div class="form-group">
              <div class="input-group d-flex aling-items-center">
                <span class="input-group-addon p-1">
                  <i class="fas fa-copyright text-info h5 m-0 mt-1"></i>
                </span>
                <input type="text" class="form-control" name="product-title" placeholder="Ingresa la marca">
              </div>
            </div>
            <div class="form-group">
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="input-group">
                    <span class="input-group-addon p-1">
                      <i class="fas fa-shopping-cart text-info h5 m-0 mt-1"></i>
                    </span>
                ...
                <div class="col-md-4">
                  <div class="input-group">
                    <span class="input-group-addon p-1">
                      <i class="fas fa-money-bill-alt text-info h5 m-0 mt-1"></i>
                    </span>
                    <input type="number" class="form-control" name="buying-price" placeholder="Precio de compra">
                    <span class="input-group-addon p-1">.00</span>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="input-group">
