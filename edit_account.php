...
<div class="row">
    ...
    <div class="panel panel-default shadow-sm">
      <div class="panel-heading">
        <div class="panel-heading clearfix">
          <i class="fas fa-camera text-info h5 m-0 mr-1"></i>
          ...
          <div class="col-md-8">
            <form class="form" action="edit_account.php" method="POST" enctype="multipart/form-data">
              <div class="form-group mt-2">
                <input type="file" name="file_upload" multiple="multiple" class="btn btn-secondary" />
              </div>
              <div class="form-group">
                <input type="hidden" name="user_id" value="<?php echo $user['id']; ?>">
                <button type="submit" name="submit" class="btn btn-info">Cambiar</button>
              </div>
            </form>
          </div>
        </div>
  ...
  <div class="col-12 col-md-6">
    <div class="panel panel-default shadow-sm">
      <div class="panel-heading clearfix">
        <i class="fas fa-user text-info h5 m-0 mr-1"></i>
