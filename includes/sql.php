...
/*--------------------------------------------------------------*/
/* Función para el conteo del id por nombre de la tabla
/*--------------------------------------------------------------*/
...
/* Inicie sesión con los datos proporcionados en $ _POST,
  ...
  /* Si se usa este método, elimine la función de autenticación.
 /*--------------------------------------------------------------*/
...
/*--------------------------------------------------------------*/
/* Encuentra usuario de inicio de sesión actual por id de sesión
  /*--------------------------------------------------------------*/
...
/*--------------------------------------------------------------*/
/* Encuentra todos los usuarios  por
  /* Unirse a la tabla de users y la tabla de user gropus
  /*--------------------------------------------------------------*/
...
/*--------------------------------------------------------------*/
/* Función para encontrar todo el nombre del producto
   /* unidos con la tabla de categorías y medios de base de datos 
   /*--------------------------------------------------------------*/
...
/*--------------------------------------------------------------*/
/* Función para encontrar toda la información del producto por título de producto
