  ...
  <div class="col-md-12">
    <div class="panel panel-default shadow-sm">
      <div class="panel-heading clearfix">
        <i class="fas fa-image text-info m-0 mr-1"></i>
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-btn">
                  <input type="file" name="file_upload" multiple="multiple" class="btn btn-secondary mr-1" />
                </span>

                <button type="submit" name="submit" class="btn btn-info">
                  <i class="fas fa-arrow-up text-light h3 m-0"></i>
                </button>
              </div>
            </div>
          </form>
            ...
            <?php foreach ($media_files as $media_file) : ?>
              <tr class="list-inline">
                ...
                <td class="text-center">
                  <img src="uploads/products/<?php echo $media_file['file_name']; ?>" width="75" height="75" />
                </td>
                <td class="text-center">
